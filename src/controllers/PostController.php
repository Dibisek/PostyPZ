...
class PostController extends AppController
{
    ...
    {   
        ...
        if ($this->isPost() && is_uploaded_file($_FILES['image']['tmp_name']) && $this->validate($_FILES['image'])) {
            ...
            if ($hasNull) {
                return $this->render('addPost', ['messages' => $message]);  
            }
    ...
    public function mainpage() {
        ...
        $rates = $this->ratingRepository->getUserRatingList($id_user);
        $this -> render('mainpage',['posts' => $posts, 'rates' => $rates] );
